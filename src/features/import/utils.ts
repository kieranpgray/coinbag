...
const VALID_ASSET_TYPES: Asset['type'][] = [
  'Property',
  'Other asset',
  'Vehicle',
  'Crypto',
...
const VALID_LIABILITY_TYPES: Liability['type'][] = [
  'Home loan',
  'Personal loan',
  'Car loan',
  'Credit card',
...
export function normalizeLiabilityType(value: string | undefined): Liability['type'] | null {
  ...
  const typeMap: Record<string, Liability['type']> = {
    ...
    'hecs': 'HECS / HELP debt',
    'help': 'HECS / HELP debt',
    'hecs/help': 'HECS / HELP debt',
    'hecs debt': 'HECS / HELP debt',
    'student loan': 'HECS / HELP debt',
    'other': 'Other liability',
    'others': 'Other liability',
    'other liability': 'Other liability',
    'misc': 'Other liability',
