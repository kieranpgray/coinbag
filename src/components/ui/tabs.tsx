...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex flex-wrap h-auto items-center justify-start rounded-md bg-muted p-1 text-muted-foreground gap-1',
      className
    )}
    {...props}
  />
